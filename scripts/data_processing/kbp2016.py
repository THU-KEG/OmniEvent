"""
@ File:    tac-kbp2016_sent.py
@ Author:  Zimu Wang
# Update:  June 10, 2022
@ Purpose: Convert the TAC KBP 2016 dataset in sentence level.
"""
import copy
import re
import jsonlines
...
class Config(object):
    ...
    def __init__(self):
        ...
        # The configurations for the pilot data.
        self.PILOT_DATA_FOLDER = os.path.join(self.PROJECT_FOLDER, 'tac_kbp_event_arg_comp_train_eval_2016-2017/'
                                                                   'data/2016/pilot')
        ...
        self.EVAL_SOURCE_FOLDER_DF = os.path.join(self.PROJECT_FOLDER, 'tac_kbp_eval_src_2016-2017/data/2016/'
                                                                       'eng/df')
        self.EVAL_SOURCE_FOLDER_NW = os.path.join(self.PROJECT_FOLDER, 'tac_kbp_eval_src_2016-2017/data/2016/'
                                                                       'eng/nw')
