...
def read_xml(gold_folder: str,
    ...
    Returns:
        ...
        {"id": "4c2488e10c34e5412d3b67e794c9bc84", "text": "",
         "events": [
            {"type": "attack",
             "triggers": [{"id": "em-341", "trigger_word": "invasion", "position": [1402, 1410],
                           "arguments": [{"role": "attacker", "mentions": [
                            {"id": "m-231", "mention": "Vietnam", "position": [1356, 1363]}, ... ]}, ... ]},
                          ... ]}, ... ],
         "negative_triggers": [],
         "entities": [{"type": "PER",
                       "mentions": [{"id": "m-51", "mention": "the blog owner", "position": [971, 985]}, ... ], ... ]}
...
def read_source(documents: list,
    ...
    Returns:
        ...
        {"id": "4c2488e10c34e5412d3b67e794c9bc84", "text": "High-Ranking Officials Confusing, ...",
         "events": [
            {"type": "attack",
             "triggers": [{"id": "em-341", "trigger_word": "invasion", "position": [1128, 1136],
                           "arguments": [{"role": "attacker", "mentions": [
                            {"id": "m-231", "mention": "Vietnam", "position": [1082, 1089]}, ... ]}, ... ]},
                          ... ]}, ... ],
         "negative_triggers": [],
         "entities": [{"type": "PER",
                       "mentions": [{"id": "m-51", "mention": "the blog owner", "position": [770, 784]}, ... ], ... ]}
...
def sentence_tokenize(documents: list):
    ...
    Returns:
        ...
        {"id": "4c2488e10c34e5412d3b67e794c9bc84-0", "text": "High-Ranking Officials Confusing, ...",
         "events": [], "negative_triggers": [],
         "entities": [{"type": "GPE",
                       "mentions": [{"id": "m-75", "mention": "China", "position": [59, 64]}, ... ], ... ]}

        documents_without_event: A list of dictionaries containing the sentences not contain any triggers and entities
        within. For example:

        {"id": "4c2488e10c34e5412d3b67e794c9bc84", "sentences": ["Such a position lacked logic."]}
