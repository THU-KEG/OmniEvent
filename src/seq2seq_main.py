...
from OpenEE.input_engineering.seq2seq_converter import Seq2SeqTemplate
...
# Seq2Seq converter
seq2seq_converter = Seq2SeqTemplate(data_args.ontology_file)
training_args.seq2seq_converter = seq2seq_converter
data_args.seq2seq_converter = seq2seq_converter
...
if model_args.paradigm == "seq2seq":
...
training_args.golden_arguments = eval_dataset.get_golden_arguments()
...
if training_args.do_predict:
    ...
    training_args.golden_arguments = test_dataset.get_golden_arguments()
