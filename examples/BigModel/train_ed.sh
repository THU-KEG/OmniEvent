...
OPTS+=" --save ${BASE_PATH}/results/finetune-mt5-${VERSION}-ed"
...
OPTS+=" --loss-scale 128"
OPTS+=" --train_file ../../data/processed/all-ed/train.unified.jsonl"
OPTS+=" --validation_file ../../data/processed/all-ed/dev.unified.jsonl"
OPTS+=" --test_file ../../data/processed/all-ed/test.unified.jsonl"
