...
OPTS+=" --model-config configs/t5-v1_1-${VERSION}/"
OPTS+=" --epochs 10"
OPTS+=" --do_train"
# OPTS+=" --do_test"
OPTS+=" --batch-size 16"
...
OPTS+=" --save ${BASE_PATH}/results/finetune-t5-v1_1-${VERSION}-ed"
...
OPTS+=" --loss-scale 128"
OPTS+=" --train_file ../../data/processed/MAVEN/train.unified.jsonl"
OPTS+=" --validation_file ../../data/processed/MAVEN/valid.unified.jsonl"
OPTS+=" --test_file ../../data/processed/MAVEN/valid.unified.jsonl"
...
CMD="python3 -m torch.distributed.launch ${DISTRIBUTED_ARGS} ${BASE_PATH}/train_ed.py ${OPTS}"
echo ${CMD}
