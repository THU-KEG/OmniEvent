...
OPTS+=" --save ${BASE_PATH}/results/MAVEN-${TYPE}-${VERSION}"
# OPTS+=" --checkpoint_path ${BASE_PATH}/results/MAVEN-${TYPE}-${VERSION}/pytorch_model.pt"
...
OPTS+=" --test_file ../../data/processed/MAVEN/test.unified.jsonl"
