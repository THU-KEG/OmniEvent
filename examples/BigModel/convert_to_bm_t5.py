...
def main():
    ...
    ver, layernum = ver_layernum[1]
    indir = f"/ldata/ph/OpenEE/examples/EAE/output/ALL-EAE/EAE/seq2seq/t5-{ver}/forbm/"
    inpath = os.path.join(indir, "pytorch_model.bin")
    outdir = Path(f"configs/t5-{ver}")
