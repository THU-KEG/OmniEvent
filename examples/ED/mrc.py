...
from OmniEvent.input_engineering.mrc_processor import EDMRCProcessor

from OmniEvent.model.model import get_model
from OmniEvent.backbone.backbone import get_backbone

from OmniEvent.evaluation.metric import compute_mrc_trigger_F1
from OmniEvent.evaluation.utils import predict, dump_preds
from OmniEvent.evaluation.convert_format import get_ace2005_trigger_detection_mrc
...
model = get_model(model_args, backbone, training_args.task_name)
model.cuda()

data_class = EDMRCProcessor
metric_fn = compute_mrc_trigger_F1
...
if training_args.do_predict:
    ...
    if data_args.test_exists_labels:
        ...
        pred_labels = get_ace2005_trigger_detection_mrc(preds, labels, data_args.test_file, data_args, test_dataset.is_overflow)
    else:
        pass
    # TODO: MAVEN & LEVEN submission
