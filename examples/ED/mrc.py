...
from OmniEvent.evaluation.convert_format import get_trigger_detection_mrc
...
if training_args.do_predict:
    ...
    if data_args.test_exists_labels:
        ...
        pred_labels = get_trigger_detection_mrc(preds, labels, data_args.test_file, data_args, test_dataset.is_overflow)
    else:
        pass
