...
class T5(BaseModel): 
    ...
    def forward(self, 
                ...
                decoder_shift_right: Optional[bool] = True,
        ...
        with torch.no_grad():
            ...
            if decoder_shift_right:
                shifted_input_ids = self._shift_right(decoder_input_ids)
            else:
                shifted_input_ids = decoder_input_ids
        ...
        hidden_states_dec = self.input_embedding(shifted_input_ids) if decoder_inputs_embeds is None else decoder_inputs_embeds
